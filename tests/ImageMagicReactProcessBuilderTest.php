...
class ImageMagicReactProcessBuilderTest extends TestCase
{
    ...
    public function removesPrefixFromImagePathWhenProvidedInOptions()
    {
        $this->assertEquals(
            ...
            ImageMagicReactProcessBuilder::create(10, ['path' => '/top/directory'])
    ...
    /** @test */
    public function notFullWhenDefaultLimitIsNotReached()
    {
        $builder = ImageMagicReactProcessBuilder::create()
            ...
            ->withResize('original6.jpg', 'original6-small.jpg', 300, 400)
            ->withResize('original7.jpg', 'original7-small.jpg', 300, 400)
            ->withResize('original8.jpg', 'original8-small.jpg', 300, 400)
            ->withResize('original9.jpg', 'original9-small.jpg', 300, 400);
    ...
    public function notifiesFullWhenDefaultLimitIsReached()
    {
        $builder = ImageMagicReactProcessBuilder::create()
            ...
            ->withResize('original8.jpg', 'original8-small.jpg', 300, 400)
            ->withResize('original9.jpg', 'original9-small.jpg', 300, 400)
            ->withResize('original10.jpg', 'original10-small.jpg', 300, 400)
        ;
    ...
    /** @test */
    public function allowsToSpecifyCustomLimit()
    {
        $builder = ImageMagicReactProcessBuilder::create(3)
            ->withResize('original1.jpg', 'original1-big.jpg', 600, 700)
            ->withResize('original2.jpg', 'original2-thumb.jpg', 150, 150)
            ->withResize('original3.jpg', 'original3-small.jpg', 300, 400);
    ...
    public function allowsToSpecifyQualityOption()
    {
        $this->assertEquals(
            ...
            ImageMagicReactProcessBuilder::create(1, ['quality' => 95])
                ->withResize('original1.jpg', 'original1-big.jpg', 600, 700)
                ->withResize('original1.jpg', 'original1-small.jpg', 300, 400)
                ->withResize('original1.jpg', 'original1-thumb.jpg', 150, 150)
                ->build()
    ...
    public function allowsToSpecifyInterlaceOption()
    {
        $this->assertEquals(
            ...
            ImageMagicReactProcessBuilder::create(1, ['interlace' => 'JPEG'])
                ->withResize('original1.jpg', 'original1-big.jpg', 600, 700)
                ->withResize('original1.jpg', 'original1-small.jpg', 300, 400)
                ->withResize('original1.jpg', 'original1-thumb.jpg', 150, 150)
                ->build()
    ...
    public function allowsToSpecifySamplingFactoryOption()
    {
        $this->assertEquals(
            ...
            ImageMagicReactProcessBuilder::create(1, ['sampling' => '4:2:0'])
                ->withResize('original1.jpg', 'original1-big.jpg', 600, 700)
                ->withResize('original1.jpg', 'original1-small.jpg', 300, 400)
                ->withResize('original1.jpg', 'original1-thumb.jpg', 150, 150)
                ->build()
    ...
    public function allowsToSpecifyStripOption()
    {
        $this->assertEquals(
            ...
            ImageMagicReactProcessBuilder::create(1, ['strip' => true])
                ->withResize('original1.jpg', 'original1-big.jpg', 600, 700)
                ->withResize('original1.jpg', 'original1-small.jpg', 300, 400)
                ->withResize('original1.jpg', 'original1-thumb.jpg', 150, 150)
                ->build()
    ...
    public function allowsToSpecifyFilterOption()
    {
        $this->assertEquals(
            ...
            ImageMagicReactProcessBuilder::create(1, ['filter' => 'Hamming'])
                ->withResize('original1.jpg', 'original1-big.jpg', 600, 700)
                ->withResize('original1.jpg', 'original1-small.jpg', 300, 400)
                ->withResize('original1.jpg', 'original1-thumb.jpg', 150, 150)
                ->build()
